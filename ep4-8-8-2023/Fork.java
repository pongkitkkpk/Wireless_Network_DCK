public class Fork {
    ...
    public String getHolderName() { // ทำการคืนค่าของ Philosopher
        return holderName; 
    }

    // Philosopher เรียกใช้เมื่อต้องการใช้ส้อม ถ้าส้อมไม่ว่างให้คืนค่า false
    // ถ้าส้อมว่างจะต้องตั้งค่า taked และใส่ชื่อคนที่จะใช้ส้อม และคืนค่า true ว่าสามารถหยิบส้อมมาใช้งานได้
